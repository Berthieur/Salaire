...
app = Flask(__name__)
CORS(app)  # Autorise les requêtes depuis Android
...
def get_zone_statistics(employeeId):
    # Exemple statique – à remplacer par vrai calcul
    return jsonify([
...
def activate_buzzer():
    ...
    # Ici tu pourrais envoyer un signal MQTT ou WebSocket à l'ESP32
    return jsonify({
